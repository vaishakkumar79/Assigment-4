...
<center>
    ...
    <form method="post" autocomplete="false">
        <table border="1">            
            <tr>
                <td>Photo</td>
                <td><input type="file" name="pic"  placeholder="Photo"/></td>
            </tr>
            <tr>
                <td>Employee No</td>
                <td><input type="text" name="eno"  placeholder="Employee Number"/></td>
            </tr>
            <tr>
                <td>First Name</td>
            ...
            <tr>
                <td>Designation</td>
                <td><input type="text" name="desig"  placeholder="Designation"/></td>
            </tr>
            <tr>
...
<?php   
    ...
    {   
        ...
        <img src="<?php echo $pic; ?>" alt="image" width="250" height="250"><br><?php
        if($cat == 'part_time'){
        echo "The Basic Salary is $basic </br>"; 
        echo "The Salary is $salary";          
        }
        elseif($cat == 'full_time'){
        echo "The Basic Salary is $basic </br>"; 
        echo "The DA is $da </br>";        
        echo "The HRA is $hra </br>"; 
        echo "The PF is $pf </br>"; 
        echo "The Tax is $tax </br>"; 
        echo "The Gross Salary is $gross </br>"; 
        echo "The Net Salary is $salary </br>";           
        }
        elseif($cat == 'contract'){
        echo "The Basic Salary is $basic </br>"; 
        echo "The DA is $da </br>";       
