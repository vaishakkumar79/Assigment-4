			...
			<div>
				<form method="POST">				
					...
					<table border="1">
						...
						<tr>
							<td>SL.Number</td>
							<td><input type="text" name="sl_num" value="<?php echo $item_sl; ?>" readonly></td>
						</tr>
						<tr>
							<td>Item Name</td>
						...
						<tr>
							<td>Item Price</td>
							<td><input class="w3-input" type="text" name="item_price" value="<?php echo $item_price; ?>" readonly></td>
						</tr>
						<tr>
							<td>Item Code</td>
